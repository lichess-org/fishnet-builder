...
#define _IOT_mtget _IOT (_IOTS (_arch_long), 7, 0, 0, 0, 0)
#define _IOT_mtpos _IOT_SIMPLE (_arch_long)
#define _IOT_mtconfiginfo _IOT (_IOTS (_arch_long), 2, _IOTS (short), 3, _IOTS (_arch_long), 1)

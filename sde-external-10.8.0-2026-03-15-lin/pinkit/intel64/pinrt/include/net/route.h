...
struct rtentry {
	unsigned _arch_long rt_pad1;
	struct sockaddr rt_dst;
	struct sockaddr rt_gateway;
	struct sockaddr rt_genmask;
	unsigned short int rt_flags;
	short int rt_pad2;
	unsigned _arch_long rt_pad3;
	unsigned char rt_tos;
	unsigned char rt_class;
	short int rt_pad4[sizeof(_arch_long)/2-1];
	short int rt_metric;
	char *rt_dev;
	unsigned _arch_long rt_mtu;
	unsigned _arch_long rt_window;
...
struct in6_rtmsg {
	...
	unsigned _arch_long rtmsg_info;

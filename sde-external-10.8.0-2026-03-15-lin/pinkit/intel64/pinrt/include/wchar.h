...
_arch_long wcstol (const wchar_t *__restrict, wchar_t **__restrict, int);
unsigned _arch_long wcstoul (const wchar_t *__restrict, wchar_t **__restrict, int);
...
#if defined (PIN_RT)
# include "arch/additional/pin_wchar.h"
#endif

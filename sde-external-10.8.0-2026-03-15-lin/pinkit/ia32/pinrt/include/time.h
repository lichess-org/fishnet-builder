...
PINCRT_DLL_DATA_VIS char *tzname[2];
#else
...
#if defined(TARGET_WINDOWS)
PINCRT_DLL_DATA_VIS int daylight;
PINCRT_DLL_DATA_VIS _arch_long timezone;
PINCRT_DLL_DATA_VIS int getdate_err;
#else
extern int daylight;
extern _arch_long timezone;

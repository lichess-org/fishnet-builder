...
/*!
 * @file
 * This header was copied as is from OS-APIS without checking what is actually still needed for the transition time to Pin4
 * and what is not needed. (Only did minor changes)
 */

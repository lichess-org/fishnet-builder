...
{
    unsigned _arch_long r15, r14, r13, r12, rbp, rbx, r11, r10, r9, r8;
    unsigned _arch_long rax, rcx, rdx, rsi, rdi, orig_rax, rip;
    unsigned _arch_long cs, eflags, rsp, ss, fs_base, gs_base, ds, es, fs, gs;
};
#define ELF_NGREG 27
...
struct user
{
    ...
    char u_comm[32];
    unsigned _arch_long u_debugreg[8];
};

...
#define FAN_EVENT_OK(meta, len) ((_arch_long)(len) >= (_arch_long)FAN_EVENT_METADATA_LEN && (_arch_long)(meta)->event_len >= (_arch_long)FAN_EVENT_METADATA_LEN && (_arch_long)(meta)->event_len <= (_arch_long)(len))

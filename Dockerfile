...
RUN apk --no-cache --force-overwrite add git make curl clang compiler-rt llvm rustup sccache /opt/glibc.apk /opt/glibc-bin.apk && rm /opt/glibc.apk /opt/glibc-bin.apk
